/* Generating random locations based on continent landmasses, to avoid oceans coordinates */
...
var RandomGeolocation = {
  randomLatlng: function () {
    ...
    var rLat = randomRange(randomBox.ll.lat, randomBox.ul.lat);
    var rLng = randomRange(randomBox.ul.lng, randomBox.ur.lng);
...
export default RandomGeolocation;

/* module.exports = RandomGeolocation;*/
